                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle text-start" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                            ...
                            <li><a class="dropdown-item" href="/LogIssue/logout.php" id="out">Logout </a></li>
                        </ul>
                </li>
                    <li class="menuIsu menuIsu2"><a class="dropdown-item rounded-3" href="/LogIssue/admin/hsse.php">HSSE</a></li>
                    <li class="menuIsu menuIsu2"><a class="dropdown-item rounded-3" href="/LogIssue/admin/opPlanning.php">Op.Planning & Control </a></li>
                    <li class="menuIsu menuIsu2" id="active"><a class="dropdown-item rounded-3" href="/LogIssue/admin/operational.php">Operational </a></li>
                <li class="nav-item rounded-3">
            ...
            <div class="row justify-content-end">
                    <div class="col-3 text-end mt-2">
                        <form method="post" action="../print.php">
                            ...
                            <input type="hidden" name="laman" value="operational-admin">
                            <button type="submit" class="btn btn-primary shadow-sm"><i class="bi bi-printer-fill"></i> Cetak</button>
                        </form>
                    </div>
                </div>
                <div class="col-3 col-sm-4">
                    <button class="btnIsu mt-5 rounded-3 shadow-sm" >Operational</button>
                </div>
            </div>
                <div class="col">
