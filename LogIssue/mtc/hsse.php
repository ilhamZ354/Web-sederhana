        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="nav-item rounded-3">
                    ...
                    <li class="menuIsu menuIsu2" id="active"><a class="dropdown-item rounded-3" href="/LogIssue/mtc/hsse.php">HSSE</a></li>
                    <li class="menuIsu menuIsu2"><a class="dropdown-item rounded-3" href="/LogIssue/mtc/opPlanning.php">Op.Planning & Control </a></li>
            ...
            <div class="row justify-content-end">
                    <div class="col-3 text-end mt-2">
                        <form method="post" action="../print.php">
                            ...
                            <input type="hidden" name="laman" value="hsse-mtc">
                            <button type="submit" class="btn btn-primary shadow-sm"><i class="bi bi-printer-fill"></i> Cetak</button>
                        </form>
                    </div>
                </div>
                <div class="col-3 col-sm-4">
                    <button class="btnIsu mt-5 rounded-3 shadow-sm" >HSSE</button>
                </div>
            </div>
                <div class="col">
