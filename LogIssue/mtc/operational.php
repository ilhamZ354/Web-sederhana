        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="nav-item rounded-3">
                    ...
                    <li class="menuIsu menuIsu2" id="active"><a class="dropdown-item rounded-3" href="/LogIssue/mtc/operational.php">Operational </a></li>
                <li class="nav-item rounded-3">
                ...
                if ($update) {
                    echo "<script>
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                window.location.href = 'operational.php';
                            }
                        });
                    </script>";
                }
